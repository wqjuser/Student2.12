...
public class Qxx_counselorMgeReceiveActivity extends Activity {
        ...
        public void onSuccess(String content) {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if (counselor_no.equals(receiveno)) {
            ...
            adapter = new Qxx_MessageAdapter(Qxx_counselorMgeReceiveActivity.this, itemList);
    ...
    class ItemClick implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> paramAdapterView,
            ...
            Map<String, Object> localMap = Qxx_counselorMgeReceiveActivity.this.itemList
                    .get(paramInt);
            ...
            Qxx_counselorMgeReceiveActivity.this.adapter.notifyDataSetChanged();
        }
    ...
    public void showUpdate() {
        ...
        new Thread() {//ע����û��װ���߳�
            ...
            public void run() {
                ...
                conn.Postclient(path, "", handler2); //��post�����ύ����
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.qxx_counselor_mge_receive, menu);
        return true;
    }
