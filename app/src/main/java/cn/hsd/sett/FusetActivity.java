...
public class FusetActivity extends AppCompatActivity {
    ...
    SDS_ZMHandler handler = new SDS_ZMHandler() {
        ...
        public void onSuccess(String content) {
            ...
            if ("1".equals(content)) {
                ...
                Toast.makeText(FusetActivity.this, "提交成功", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(FusetActivity.this, wqj_ID_MainActivity.class);
        ...
        public void onFailture(String content) {
            Toast.makeText(FusetActivity.this, "与服务器连接失败", Toast.LENGTH_LONG).show();
    ...
    public void commit(View v) {
        if (pass1.length() == 0 || pass2.length() == 0 || pass3.length() == 0) {
            Toast.makeText(FusetActivity.this, "请填写完整", Toast.LENGTH_SHORT).show();
        } else if (!(pass1.equals(gxqStatic.pass))) {
            Toast.makeText(FusetActivity.this, "原始密码不正确", Toast.LENGTH_SHORT).show();
        } else if (!(pass2.equals(pass3))) {
            Toast.makeText(FusetActivity.this, "两次密码不一致", Toast.LENGTH_SHORT).show();
