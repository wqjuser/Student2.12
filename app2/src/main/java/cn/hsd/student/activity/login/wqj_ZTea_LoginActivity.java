        ...
        wqj_zt_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (tv1.length() == 0 && tv2.length() == 0) {
                    Toast.makeText(wqj_ZTea_LoginActivity.this, "身份证号或密码不能为空", Toast.LENGTH_LONG).show();

                } else if (tv1.length() < 13) {
                    Toast.makeText(wqj_ZTea_LoginActivity.this, "身份证号错误或者格式不正确", Toast.LENGTH_LONG).show();
                    ...
                    final Handler handler = new Handler() {
                        ...
                        public void handleMessage(Message msg) {
                            ...
                            if (msg.what == 0) {
                                Toast.makeText(wqj_ZTea_LoginActivity.this, "登陆成功", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(wqj_ZTea_LoginActivity.this, "登录失败", Toast.LENGTH_SHORT).show();
                            }
                        }
                    };
                    new Thread() {
