...
public class wqj_FTea_LoginActivity extends AppCompatActivity {
    private Button wqj_ft_bt;
        ...
        wqj_ft_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (tv1.length() == 0 && tv2.length() == 0) {
                    Toast.makeText(wqj_FTea_LoginActivity.this, "身份证号或密码不能为空", Toast.LENGTH_LONG).show();

                } else if (tv1.length() < 13) {
                    Toast.makeText(wqj_FTea_LoginActivity.this, "身份证号错误或者格式不正确", Toast.LENGTH_LONG).show();
                    ...
                    final Handler handler = new Handler() {
                        ...
                        public void handleMessage(Message msg) {
                            ...
                            if (msg.what == 0) {
                                Toast.makeText(wqj_FTea_LoginActivity.this, "登陆成功", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(wqj_FTea_LoginActivity.this, "登录失败", Toast.LENGTH_SHORT).show();
                            }
                        }
                    };
                    new Thread() {
   ...
   /* public class StuBtuOnClickListener implements View.OnClickListener{
        public void onClick(View v){
            if(tv2.length()==0||tv1.length()==0){
                Toast.makeText(wqj_FTea_LoginActivity.this,"学号或密码不能为空",Toast.LENGTH_LONG).show();
            }
            else if(tv1.length()<10){
                Toast.makeText(wqj_FTea_LoginActivity.this,"学号格式错误或者长度不够",Toast.LENGTH_LONG).show();
            }
            else if(tv2.length()<6){
                Toast.makeText(wqj_FTea_LoginActivity.this,"密码错误",Toast.LENGTH_LONG).show();
            }
